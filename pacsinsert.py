...
default_input_path = r'./_workdir_'
default_output_path = r'./_workdir_'
...
if __name__ == '__main__':
    ...
    parser.add_argument('-cfgfile', default='pacsinsert.ini', help='Use specified file for configuration.')
    ...
    dictConfig(init_log_dictionary)

    config = get_config("pacsinsert.ini")
